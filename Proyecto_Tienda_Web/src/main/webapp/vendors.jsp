...
<body>
	...
	<div id="main-content">
		...
		<div class="container">
			<h5 class="text-center mt-5">Registro Proveedores</h5>
			<br>
				...
				<form action="ServletGestionUsuario" method="post">
					...
					<div class="col-md-3"></div>
						<div class="form-group col-md-3">
							<label>NIT*</label> 
								<input required type="text" class="form-control" placeholder="Ingrese nit del proveedor" />
						</div>
						<div class="col-md-1"></div>
						<div class="form-group col-md-3">
							<label>Telefono*</label> <input required type="text"
								class="form-control" placeholder="Telefono proveedor" />
					...
					<div class="form-row">
						...
						<div class="form-group col-md-7">
							<label>Nombre Proveedor*</label> <input required type="text"
								class="form-control" placeholder="Razon social proveedor/empresa" />
						</div>
					</div>
					<div class="form-row">
					<div class="col-md-3"></div>
						<div class="form-group col-md-7">
							<label>Direccion*</label> <input required type="email"
								class="form-control" placeholder="Direccion del proveedor" />
						</div>
					</div>
					<div class="form-row">
						<div class="col-md-3"></div>
						<div class="form-group col-md-7">
							<label>Ciudad*</label> <input required type="text"
								class="form-control" placeholder="Ciudad proveedor" />
						</div>
					</div>
